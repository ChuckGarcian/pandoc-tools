...
def main():
    ...
    ignore_file_patterns = ['_dir', 'readme.md']
    ...
    for root, dir_names, file_names in os.walk(target_folder_path):
        ...
        new_index_path = os.path.join(root, f'{root_base}_dir.md')
        ...
        if (len (dir_names) > 1):
            ...
            for dir_base in dir_names:
                ...
                if file_exists(readme_path):
                    ...
                    s = f'- [{dir_base}]({dir_base}/{dir_base}_dir.html):'
                    new_index.write (s)
